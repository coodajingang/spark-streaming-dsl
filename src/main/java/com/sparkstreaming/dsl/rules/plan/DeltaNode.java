...
public class DeltaNode implements LogicalPlan {
    private final LogicalPlan child;
    private final Duration window;

    public DeltaNode(LogicalPlan child, Duration window) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(child, deltaNode.child) &&
               Objects.equals(window, deltaNode.window);
    }
